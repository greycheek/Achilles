...
function LoadSaveGame( name$,dialogTitle$ )
	...
	TSize = (32*dev.scale)
	Text( MapText,dialogTitle$,alertDialog.x+(TSize*.85),alertDialog.y+(TSize*.6),50,50,50,TSize,255,0,On )
...
function SlotDialog( name$,dialogTitle$ )
	PlaySound( ClickSound,vol )
	TSize = ( 32*dev.scale )
	Text( MapText,dialogTitle$,mapSlotDialog.x+20,mapSlotDialog.y+20,50,50,50,TSize,255,0,On )
