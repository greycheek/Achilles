...
//~ remstart
		LoadImage( RoughScale.ID,"RoughScale.png" )
		...
		SetSpriteDepth( RoughScale.ID,0 )

		LoadImage( RoughSlide.ID,"RoughSlider.png" )
		CreateSprite( RoughSlide.ID,RoughScale.ID )
		...
		LoadImage( TreeScale.ID,"TreesScale.png" )
		...
		LoadImage( BaseScale.ID,"BaseScale.png" )
		...
		LoadImage( DepotScale.ID,"DepotScale.png" )
		...
		SetSpriteDepth( DepotScale.ID,0 )
